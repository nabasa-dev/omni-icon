...
use OmniIconDeps\Twig\DeprecatedCallableInfo;
use OmniIconDeps\Twig\Environment;
use OmniIconDeps\Twig\Error\LoaderError;
use OmniIconDeps\Twig\Error\RuntimeError;
use OmniIconDeps\Twig\Error\SyntaxError;
use OmniIconDeps\Twig\ExpressionParser\Infix\ArrowExpressionParser;
use OmniIconDeps\Twig\ExpressionParser\Infix\BinaryOperatorExpressionParser;
use OmniIconDeps\Twig\ExpressionParser\Infix\ConditionalTernaryExpressionParser;
use OmniIconDeps\Twig\ExpressionParser\Infix\DotExpressionParser;
use OmniIconDeps\Twig\ExpressionParser\Infix\FilterExpressionParser;
use OmniIconDeps\Twig\ExpressionParser\Infix\FunctionExpressionParser;
use OmniIconDeps\Twig\ExpressionParser\Infix\IsExpressionParser;
use OmniIconDeps\Twig\ExpressionParser\Infix\IsNotExpressionParser;
use OmniIconDeps\Twig\ExpressionParser\Infix\SquareBracketExpressionParser;
use OmniIconDeps\Twig\ExpressionParser\InfixAssociativity;
use OmniIconDeps\Twig\ExpressionParser\PrecedenceChange;
use OmniIconDeps\Twig\ExpressionParser\Prefix\GroupingExpressionParser;
use OmniIconDeps\Twig\ExpressionParser\Prefix\LiteralExpressionParser;
use OmniIconDeps\Twig\ExpressionParser\Prefix\UnaryOperatorExpressionParser;
use OmniIconDeps\Twig\Markup;
use OmniIconDeps\Twig\Node\Expression\AbstractExpression;
use OmniIconDeps\Twig\Node\Expression\Binary\AddBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\AndBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\BitwiseAndBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\BitwiseOrBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\BitwiseXorBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\ConcatBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\DivBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\ElvisBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\EndsWithBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\EqualBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\FloorDivBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\GreaterBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\GreaterEqualBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\HasEveryBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\HasSomeBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\InBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\LessBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\LessEqualBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\MatchesBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\ModBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\MulBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\NotEqualBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\NotInBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\NullCoalesceBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\OrBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\PowerBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\RangeBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\SpaceshipBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\StartsWithBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\SubBinary;
use OmniIconDeps\Twig\Node\Expression\Binary\XorBinary;
use OmniIconDeps\Twig\Node\Expression\BlockReferenceExpression;
use OmniIconDeps\Twig\Node\Expression\Filter\DefaultFilter;
use OmniIconDeps\Twig\Node\Expression\FunctionNode\EnumCasesFunction;
use OmniIconDeps\Twig\Node\Expression\FunctionNode\EnumFunction;
use OmniIconDeps\Twig\Node\Expression\GetAttrExpression;
use OmniIconDeps\Twig\Node\Expression\ParentExpression;
use OmniIconDeps\Twig\Node\Expression\Test\ConstantTest;
use OmniIconDeps\Twig\Node\Expression\Test\DefinedTest;
use OmniIconDeps\Twig\Node\Expression\Test\DivisiblebyTest;
use OmniIconDeps\Twig\Node\Expression\Test\EvenTest;
use OmniIconDeps\Twig\Node\Expression\Test\NullTest;
use OmniIconDeps\Twig\Node\Expression\Test\OddTest;
use OmniIconDeps\Twig\Node\Expression\Test\SameasTest;
use OmniIconDeps\Twig\Node\Expression\Test\TrueTest;
use OmniIconDeps\Twig\Node\Expression\Unary\NegUnary;
use OmniIconDeps\Twig\Node\Expression\Unary\NotUnary;
use OmniIconDeps\Twig\Node\Expression\Unary\PosUnary;
use OmniIconDeps\Twig\Node\Expression\Unary\SpreadUnary;
use OmniIconDeps\Twig\Node\Node;
use OmniIconDeps\Twig\Parser;
use OmniIconDeps\Twig\Sandbox\SecurityNotAllowedMethodError;
use OmniIconDeps\Twig\Sandbox\SecurityNotAllowedPropertyError;
use OmniIconDeps\Twig\Source;
use OmniIconDeps\Twig\Template;
use OmniIconDeps\Twig\TemplateWrapper;
use OmniIconDeps\Twig\TokenParser\ApplyTokenParser;
use OmniIconDeps\Twig\TokenParser\BlockTokenParser;
use OmniIconDeps\Twig\TokenParser\DeprecatedTokenParser;
use OmniIconDeps\Twig\TokenParser\DoTokenParser;
use OmniIconDeps\Twig\TokenParser\EmbedTokenParser;
use OmniIconDeps\Twig\TokenParser\ExtendsTokenParser;
use OmniIconDeps\Twig\TokenParser\FlushTokenParser;
use OmniIconDeps\Twig\TokenParser\ForTokenParser;
use OmniIconDeps\Twig\TokenParser\FromTokenParser;
use OmniIconDeps\Twig\TokenParser\GuardTokenParser;
use OmniIconDeps\Twig\TokenParser\IfTokenParser;
use OmniIconDeps\Twig\TokenParser\ImportTokenParser;
use OmniIconDeps\Twig\TokenParser\IncludeTokenParser;
use OmniIconDeps\Twig\TokenParser\MacroTokenParser;
use OmniIconDeps\Twig\TokenParser\SetTokenParser;
use OmniIconDeps\Twig\TokenParser\TypesTokenParser;
use OmniIconDeps\Twig\TokenParser\UseTokenParser;
use OmniIconDeps\Twig\TokenParser\WithTokenParser;
use OmniIconDeps\Twig\TwigFilter;
use OmniIconDeps\Twig\TwigFunction;
use OmniIconDeps\Twig\TwigTest;
use OmniIconDeps\Twig\Util\CallableArgumentsExtractor;
final class CoreExtension extends AbstractExtension
{
    ...
    {
        if (!\function_exists('iconv') && !\function_exists('OmniIconDeps\iconv')) {
    ...
    public static function constant($constant, $object = null, bool $checkDefined = \false)
    {
        if (null !== $object) {
            if ('class' === $constant) {
                return $checkDefined ? \true : $object::class;
            }
    ...
    public static function getAttribute(Environment $env, Source $source, $object, $item, array $arguments = [], $type = Template::ANY_CALL, $isDefinedTest = \false, $ignoreStrictCheck = \false, $sandboxed = \false, int $lineno = -1)
    {
        ...
        if (Template::METHOD_CALL !== $type) {
            ...
            if ($object instanceof \Closure && '__invoke' === $item) {
                return $isDefinedTest ? \true : $object();
            }
        ...
        if (!isset($cache[$class])) {
            ...
            foreach ($methods as $i => $method) {
                ...
                if ('g' === $lcName[0] && str_starts_with($lcName, 'get')) {
                    ...
                    $name = substr($method, 3);
                    $lcName = substr($lcName, 3);
                    if (\in_array('is' . $lcName, $lcMethods, \true)) {
                        continue;
                    }
                } else {
                    continue;
