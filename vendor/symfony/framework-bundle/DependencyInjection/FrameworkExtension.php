 ...
 */
namespace OmniIconDeps\Symfony\Bundle\FrameworkBundle\DependencyInjection;

use OmniIconDeps\Composer\InstalledVersions;
use OmniIconDeps\Doctrine\ORM\Mapping\Embeddable;
use OmniIconDeps\Doctrine\ORM\Mapping\Entity;
use OmniIconDeps\Doctrine\ORM\Mapping\MappedSuperclass;
use OmniIconDeps\Http\Client\HttpAsyncClient;
use OmniIconDeps\Http\Client\HttpClient;
use OmniIconDeps\phpDocumentor\Reflection\DocBlockFactoryInterface;
use OmniIconDeps\phpDocumentor\Reflection\Types\ContextFactory;
use OmniIconDeps\PhpParser\Parser;
use OmniIconDeps\PHPStan\PhpDocParser\Parser\PhpDocParser;
...
use OmniIconDeps\Symfony\Bridge\Monolog\Processor\DebugProcessor;
use OmniIconDeps\Symfony\Bridge\Twig\Extension\CsrfExtension;
use OmniIconDeps\Symfony\Bundle\FrameworkBundle\Controller\AbstractController;
use OmniIconDeps\Symfony\Bundle\FrameworkBundle\Routing\RouteLoaderInterface;
use OmniIconDeps\Symfony\Bundle\FullStack;
use OmniIconDeps\Symfony\Bundle\MercureBundle\MercureBundle;
use OmniIconDeps\Symfony\Component\Asset\Package;
use OmniIconDeps\Symfony\Component\Asset\PackageInterface;
use OmniIconDeps\Symfony\Component\AssetMapper\AssetMapper;
use OmniIconDeps\Symfony\Component\AssetMapper\Compiler\AssetCompilerInterface;
use OmniIconDeps\Symfony\Component\AssetMapper\Compressor\CompressorInterface;
use OmniIconDeps\Symfony\Component\BrowserKit\AbstractBrowser;
...
use OmniIconDeps\Symfony\Component\Console\Application;
use OmniIconDeps\Symfony\Component\Console\Attribute\AsCommand;
use OmniIconDeps\Symfony\Component\Console\Command\Command;
use OmniIconDeps\Symfony\Component\Console\DataCollector\CommandDataCollector;
use OmniIconDeps\Symfony\Component\Console\Debug\CliRequest;
...
use OmniIconDeps\Symfony\Component\DependencyInjection\Argument\ArgumentTrait;
...
use OmniIconDeps\Symfony\Component\DependencyInjection\EnvVarLoaderInterface;
...
use OmniIconDeps\Symfony\Component\Dotenv\Command\DebugCommand;
use OmniIconDeps\Symfony\Component\EventDispatcher\Attribute\AsEventListener;
...
use OmniIconDeps\Symfony\Component\Finder\Finder;
use OmniIconDeps\Symfony\Component\Finder\Glob;
use OmniIconDeps\Symfony\Component\Form\EnumFormTypeGuesser;
use OmniIconDeps\Symfony\Component\Form\Extension\HtmlSanitizer\Type\TextTypeHtmlSanitizerExtension;
use OmniIconDeps\Symfony\Component\Form\Form;
use OmniIconDeps\Symfony\Component\Form\FormTypeExtensionInterface;
use OmniIconDeps\Symfony\Component\Form\FormTypeGuesserInterface;
use OmniIconDeps\Symfony\Component\Form\FormTypeInterface;
...
use OmniIconDeps\Symfony\Component\HttpClient\CachingHttpClient;
use OmniIconDeps\Symfony\Component\HttpClient\Exception\ChunkCacheItemNotFoundException;
use OmniIconDeps\Symfony\Component\HttpClient\Messenger\PingWebhookMessageHandler;
use OmniIconDeps\Symfony\Component\HttpClient\MockHttpClient;
use OmniIconDeps\Symfony\Component\HttpClient\Retry\GenericRetryStrategy;
use OmniIconDeps\Symfony\Component\HttpClient\RetryableHttpClient;
use OmniIconDeps\Symfony\Component\HttpClient\ScopingHttpClient;
use OmniIconDeps\Symfony\Component\HttpClient\ThrottlingHttpClient;
...
use OmniIconDeps\Symfony\Component\HttpKernel\Attribute\AsController;
use OmniIconDeps\Symfony\Component\HttpKernel\Attribute\AsTargetedValueResolver;
use OmniIconDeps\Symfony\Component\HttpKernel\CacheClearer\CacheClearerInterface;
...
use OmniIconDeps\Symfony\Component\HttpKernel\DependencyInjection\Extension;
use OmniIconDeps\Symfony\Component\HttpKernel\EventListener\IsSignatureValidAttributeListener;
use OmniIconDeps\Symfony\Component\HttpKernel\Log\DebugLoggerConfigurator;
use OmniIconDeps\Symfony\Component\HttpKernel\Profiler\ProfilerStateChecker;
use OmniIconDeps\Symfony\Component\JsonStreamer\Attribute\JsonStreamable;
use OmniIconDeps\Symfony\Component\JsonStreamer\JsonStreamWriter;
use OmniIconDeps\Symfony\Component\JsonStreamer\StreamReaderInterface;
use OmniIconDeps\Symfony\Component\JsonStreamer\StreamWriterInterface;
use OmniIconDeps\Symfony\Component\JsonStreamer\ValueTransformer\ValueTransformerInterface;
use OmniIconDeps\Symfony\Component\Lock\LockFactory;
use OmniIconDeps\Symfony\Component\Lock\LockInterface;
use OmniIconDeps\Symfony\Component\Lock\PersistingStoreInterface;
use OmniIconDeps\Symfony\Component\Lock\Serializer\LockKeyNormalizer;
use OmniIconDeps\Symfony\Component\Lock\Store\StoreFactory;
use OmniIconDeps\Symfony\Component\Mailer\Bridge as MailerBridge;
...
use OmniIconDeps\Symfony\Component\Mercure\HubRegistry;
use OmniIconDeps\Symfony\Component\Messenger\Attribute\AsMessage;
use OmniIconDeps\Symfony\Component\Messenger\Attribute\AsMessageHandler;
use OmniIconDeps\Symfony\Component\Messenger\Bridge as MessengerBridge;
use OmniIconDeps\Symfony\Component\Messenger\EventListener\ResetMemoryUsageListener;
use OmniIconDeps\Symfony\Component\Messenger\Handler\BatchHandlerInterface;
use OmniIconDeps\Symfony\Component\Messenger\MessageBus;
use OmniIconDeps\Symfony\Component\Messenger\MessageBusInterface;
use OmniIconDeps\Symfony\Component\Messenger\Middleware\AddDefaultStampsMiddleware;
use OmniIconDeps\Symfony\Component\Messenger\Middleware\DeduplicateMiddleware;
use OmniIconDeps\Symfony\Component\Messenger\Middleware\RouterContextMiddleware;
use OmniIconDeps\Symfony\Component\Messenger\Transport\AmqpExt\AmqpTransportFactory;
use OmniIconDeps\Symfony\Component\Messenger\Transport\RedisExt\RedisTransportFactory;
use OmniIconDeps\Symfony\Component\Messenger\Transport\Serialization\SerializerInterface;
use OmniIconDeps\Symfony\Component\Messenger\Transport\TransportFactoryInterface as MessengerTransportFactoryInterface;
use OmniIconDeps\Symfony\Component\Messenger\Transport\TransportInterface;
...
use OmniIconDeps\Symfony\Component\Notifier\Bridge as NotifierBridge;
use OmniIconDeps\Symfony\Component\Notifier\Bridge\FakeChat\FakeChatTransportFactory;
use OmniIconDeps\Symfony\Component\Notifier\Bridge\FakeSms\FakeSmsTransportFactory;
use OmniIconDeps\Symfony\Component\Notifier\ChatterInterface;
use OmniIconDeps\Symfony\Component\Notifier\Notifier;
use OmniIconDeps\Symfony\Component\Notifier\Recipient\Recipient;
use OmniIconDeps\Symfony\Component\Notifier\TexterInterface;
use OmniIconDeps\Symfony\Component\Notifier\Transport\TransportFactoryInterface as NotifierTransportFactoryInterface;
use OmniIconDeps\Symfony\Component\ObjectMapper\ConditionCallableInterface;
use OmniIconDeps\Symfony\Component\ObjectMapper\ObjectMapperInterface;
use OmniIconDeps\Symfony\Component\ObjectMapper\TransformCallableInterface;
use OmniIconDeps\Symfony\Component\Process\Messenger\RunProcessMessageHandler;
use OmniIconDeps\Symfony\Component\PropertyAccess\PropertyAccessor;
use OmniIconDeps\Symfony\Component\PropertyInfo\Extractor\ConstructorArgumentTypeExtractorInterface;
use OmniIconDeps\Symfony\Component\PropertyInfo\Extractor\PhpDocExtractor;
use OmniIconDeps\Symfony\Component\PropertyInfo\Extractor\PhpStanExtractor;
use OmniIconDeps\Symfony\Component\PropertyInfo\PropertyAccessExtractorInterface;
use OmniIconDeps\Symfony\Component\PropertyInfo\PropertyDescriptionExtractorInterface;
use OmniIconDeps\Symfony\Component\PropertyInfo\PropertyInfoExtractorInterface;
use OmniIconDeps\Symfony\Component\PropertyInfo\PropertyInitializableExtractorInterface;
use OmniIconDeps\Symfony\Component\PropertyInfo\PropertyListExtractorInterface;
use OmniIconDeps\Symfony\Component\PropertyInfo\PropertyTypeExtractorInterface;
use OmniIconDeps\Symfony\Component\RateLimiter\CompoundRateLimiterFactory;
use OmniIconDeps\Symfony\Component\RateLimiter\LimiterInterface;
use OmniIconDeps\Symfony\Component\RateLimiter\RateLimiterFactory;
use OmniIconDeps\Symfony\Component\RateLimiter\RateLimiterFactoryInterface;
use OmniIconDeps\Symfony\Component\RateLimiter\Storage\CacheStorage;
use OmniIconDeps\Symfony\Component\RemoteEvent\Attribute\AsRemoteEventConsumer;
use OmniIconDeps\Symfony\Component\RemoteEvent\RemoteEvent;
use OmniIconDeps\Symfony\Component\Routing\Attribute\Route;
use OmniIconDeps\Symfony\Component\Routing\Loader\AttributeServicesLoader;
use OmniIconDeps\Symfony\Component\Routing\Loader\XmlFileLoader as RoutingXmlFileLoader;
use OmniIconDeps\Symfony\Component\Scheduler\Attribute\AsCronTask;
use OmniIconDeps\Symfony\Component\Scheduler\Attribute\AsPeriodicTask;
use OmniIconDeps\Symfony\Component\Scheduler\Attribute\AsSchedule;
use OmniIconDeps\Symfony\Component\Scheduler\Messenger\SchedulerTransportFactory;
use OmniIconDeps\Symfony\Component\Scheduler\Messenger\Serializer\Normalizer\SchedulerTriggerNormalizer;
use OmniIconDeps\Symfony\Component\Security\Core\AuthenticationEvents;
use OmniIconDeps\Symfony\Component\Security\Core\Exception\AuthenticationException;
use OmniIconDeps\Symfony\Component\Security\Csrf\CsrfToken;
use OmniIconDeps\Symfony\Component\Security\Csrf\CsrfTokenManagerInterface;
use OmniIconDeps\Symfony\Component\Semaphore\PersistingStoreInterface as SemaphoreStoreInterface;
use OmniIconDeps\Symfony\Component\Semaphore\Semaphore;
use OmniIconDeps\Symfony\Component\Semaphore\SemaphoreFactory;
use OmniIconDeps\Symfony\Component\Semaphore\Store\StoreFactory as SemaphoreStoreFactory;
use OmniIconDeps\Symfony\Component\Serializer\Attribute as SerializerMapping;
use OmniIconDeps\Symfony\Component\Serializer\Attribute\ExtendsSerializationFor;
...
use OmniIconDeps\Symfony\Component\Translation\Bridge as TranslationBridge;
use OmniIconDeps\Symfony\Component\Translation\Command\TranslationLintCommand as BaseTranslationLintCommand;
use OmniIconDeps\Symfony\Component\Translation\Command\XliffLintCommand as BaseXliffLintCommand;
use OmniIconDeps\Symfony\Component\Translation\Extractor\PhpAstExtractor;
use OmniIconDeps\Symfony\Component\Translation\LocaleSwitcher;
use OmniIconDeps\Symfony\Component\Translation\PseudoLocalizationTranslator;
use OmniIconDeps\Symfony\Component\Translation\TranslatableMessage;
use OmniIconDeps\Symfony\Component\Translation\Translator;
use OmniIconDeps\Symfony\Component\TypeInfo\Type;
use OmniIconDeps\Symfony\Component\TypeInfo\TypeResolver\PhpDocAwareReflectionTypeResolver;
use OmniIconDeps\Symfony\Component\TypeInfo\TypeResolver\StringTypeResolver;
use OmniIconDeps\Symfony\Component\TypeInfo\TypeResolver\TypeResolverInterface;
use OmniIconDeps\Symfony\Component\Uid\Factory\UuidFactory;
use OmniIconDeps\Symfony\Component\Uid\UuidV4;
use OmniIconDeps\Symfony\Component\Validator\Attribute\ExtendsValidationFor;
use OmniIconDeps\Symfony\Component\Validator\Constraint;
use OmniIconDeps\Symfony\Component\Validator\Constraints\ExpressionLanguageProvider;
use OmniIconDeps\Symfony\Component\Validator\Constraints\Traverse;
use OmniIconDeps\Symfony\Component\Validator\ConstraintValidatorInterface;
use OmniIconDeps\Symfony\Component\Validator\DependencyInjection\AttributeMetadataPass as ValidatorAttributeMetadataPass;
use OmniIconDeps\Symfony\Component\Validator\GroupProviderInterface;
use OmniIconDeps\Symfony\Component\Validator\Mapping\Loader\PropertyInfoLoader;
use OmniIconDeps\Symfony\Component\Validator\ObjectInitializerInterface;
use OmniIconDeps\Symfony\Component\Validator\Validation;
use OmniIconDeps\Symfony\Component\Webhook\Controller\WebhookController;
use OmniIconDeps\Symfony\Component\WebLink\HttpHeaderParser;
use OmniIconDeps\Symfony\Component\WebLink\HttpHeaderSerializer;
use OmniIconDeps\Symfony\Component\Workflow;
use OmniIconDeps\Symfony\Component\Workflow\Arc;
use OmniIconDeps\Symfony\Component\Workflow\WorkflowInterface;
use OmniIconDeps\Symfony\Component\Yaml\Command\LintCommand as BaseYamlLintCommand;
use OmniIconDeps\Symfony\Component\Yaml\Yaml;
use OmniIconDeps\Symfony\Contracts\Cache\CacheInterface;
use OmniIconDeps\Symfony\Contracts\Cache\CallbackInterface;
...
use OmniIconDeps\Symfony\Contracts\Translation\LocaleAwareInterface;
/**
...
class FrameworkExtension extends Extension
{
    ...
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        if (!ContainerBuilder::willBeAvailable('symfony/string', SluggerInterface::class, ['symfony/framework-bundle'])) {
            ...
            if (!\extension_loaded('intl') && !\defined('OmniIconDeps\PHPUNIT_COMPOSER_INSTALL')) {
        ...
        $exceptionListener->replaceArgument(3, $config['exceptions'])->setArgument(4, $loggers);
        ...
        if ($messengerEnabled) {
            ...
            if ($container->hasDefinition('messenger.transport.amqp.factory') && !class_exists(MessengerBridge\Amqp\Transport\AmqpTransportFactory::class)) {
                if (class_exists(AmqpTransportFactory::class)) {
                    $container->getDefinition('messenger.transport.amqp.factory')->setClass(AmqpTransportFactory::class)->addTag('messenger.transport_factory');
                } else {
            ...
            if ($container->hasDefinition('messenger.transport.redis.factory') && !class_exists(MessengerBridge\Redis\Transport\RedisTransportFactory::class)) {
                if (class_exists(RedisTransportFactory::class)) {
                    $container->getDefinition('messenger.transport.redis.factory')->setClass(RedisTransportFactory::class)->addTag('messenger.transport_factory');
                } else {
        ...
        if (ContainerBuilder::willBeAvailable('symfony/object-mapper', ObjectMapperInterface::class, ['symfony/framework-bundle'])) {
            ...
            $container->registerForAutoconfiguration(TransformCallableInterface::class)->addTag('object_mapper.transform_callable');
            $container->registerForAutoconfiguration(ConditionCallableInterface::class)->addTag('object_mapper.condition_callable');
        }
        ...
        $container->registerAttributeForAutoconfiguration(AsCommand::class, static function (ChildDefinition $definition, AsCommand $attribute): void {
            $definition->addTag('console.command', ['command' => $attribute->name, 'description' => $attribute->description, 'help' => $attribute->help ?? null]);
        });
        ...
        $container->registerForAutoconfiguration(FormTypeInterface::class)->addTag('form.type', ['csrf_token_id' => '%.form.type_extension.csrf.token_id%']);
        ...
        $container->registerForAutoconfiguration(ConstructorArgumentTypeExtractorInterface::class)->addTag('property_info.constructor_extractor');
        ...
        foreach ([AsPeriodicTask::class, AsCronTask::class] as $taskAttributeClass) {
            $container->registerAttributeForAutoconfiguration($taskAttributeClass, static function (ChildDefinition $definition, AsPeriodicTask|AsCronTask $attribute, \ReflectionClass|\ReflectionMethod $reflector): void {
                $tagAttributes = get_object_vars($attribute) + ['trigger' => match (\true) {
        ...
        $container->registerForAutoconfiguration(Constraint::class)->addTag('container.excluded', ['source' => 'because it\'s a validation constraint']);
        ...
        $container->registerAttributeForAutoconfiguration(JsonStreamable::class, static function (ChildDefinition $definition, JsonStreamable $attribute) {
            $definition->addTag('json_streamer.streamable', ['object' => $attribute->asObject, 'list' => $attribute->asList])->addTag('container.excluded', ['source' => 'because it\'s a streamable JSON']);
        });
        ...
        $container->setParameter('container.behavior_describing_tags', ['container.do_not_inline', 'container.service_locator', 'container.service_subscriber', 'kernel.event_subscriber', 'kernel.event_listener', 'kernel.locale_aware', 'kernel.reset']);
    }
    ...
    private function registerHttpCacheConfiguration(array $config, ContainerBuilder $container, bool $httpMethodOverride, ?array $allowedHttpMethodOverride): void
    {
        ...
        if (null !== $allowedHttpMethodOverride) {
            $container->getDefinition('http_cache')->addArgument((new Definition('void'))->setFactory([Request::class, 'setAllowedHttpMethodOverride'])->addArgument($allowedHttpMethodOverride));
        }
    }
    ...
    private function registerWorkflowConfiguration(array $config, ContainerBuilder $container, PhpFileLoader $loader): void
    {
        ...
        foreach ($config['workflows'] as $name => $workflow) {
            ...
            $workflowDefinition->addTag('workflow', ['name' => $name, 'metadata' => $workflow['metadata'], 'definition_validators' => $workflow['definition_validators'], 'definition_id' => $definitionDefinitionId]);
            if ('workflow' === $type) {
    ...
    private function registerRouterConfiguration(array $config, ContainerBuilder $container, PhpFileLoader $loader, array $enabledLocales = []): void
    {
        ...
        if (null !== $config['default_uri']) {
            $container->getDefinition('router.request_context')->replaceArgument(0, $config['default_uri']);
        }
    }
    ...
    private function registerAssetMapperConfiguration(array $config, ContainerBuilder $container, PhpFileLoader $loader, bool $assetEnabled, bool $httpClientEnabled): void
    {
        ...
        if (interface_exists(CompressorInterface::class)) {
            ...
            if ($config['precompress']['enabled']) {
                $container->getDefinition('asset_mapper.local_public_assets_filesystem')->addArgument(new Reference('asset_mapper.compressor'))->addArgument($config['precompress']['extensions']);
            }
        } else {
    ...
    private function registerValidationConfiguration(array $config, ContainerBuilder $container, PhpFileLoader $loader, bool $propertyInfoEnabled): void
    {
        ...
        $container->registerAttributeForAutoconfiguration(ExtendsValidationFor::class, static function (ChildDefinition $definition, ExtendsValidationFor $attribute) {
            $definition->addTag('validator.attribute_metadata', ['for' => $attribute->class])->addTag('container.excluded', ['source' => 'because it\'s a validator constraint extension']);
        });
    ...
    private function registerPropertyAccessConfiguration(array $config, ContainerBuilder $container, PhpFileLoader $loader): void
    {
        ...
        $container->getDefinition('property_accessor')->replaceArgument(0, $magicMethods)->replaceArgument(1, $throw);
    }
    ...
    private function registerSecurityCsrfConfiguration(array $config, ContainerBuilder $container, PhpFileLoader $loader): void
    {
        ...
        $container->getDefinition('security.csrf.same_origin_token_manager')->replaceArgument(3, $config['stateless_token_ids'])->replaceArgument(4, $config['check_header'])->replaceArgument(5, $config['cookie_name']);
        if (!$this->isInitializedConfigEnabled('session')) {
            ...
            $container->getDefinition('security.csrf.same_origin_token_manager')->setDecoratedService(null)->replaceArgument(2, null);
        }
    }
    private function registerSerializerConfiguration(array $config, ContainerBuilder $container, PhpFileLoader $loader): void
    {
        ...
        if (($config['enable_attributes'] ?? \false) || class_exists(SerializerAttributeMetadataPass::class)) {
            ...
            $container->getDefinition('serializer.mapping.attribute_loader')->replaceArgument(0, $config['enable_attributes'] ?? \false);
        } else {
            // BC with symfony/serializer < 7.4
            $container->removeDefinition('serializer.mapping.attribute_services_loader');
        }
        $fileRecorder = function ($extension, $path) use (&$serializerLoaders) {
            $definition = new Definition(\in_array($extension, ['yaml', 'yml'], \true) ? YamlFileLoader::class : XmlFileLoader::class, [$path]);
        ...
        $container->registerAttributeForAutoconfiguration(ExtendsSerializationFor::class, static function (ChildDefinition $definition, ExtendsSerializationFor $attribute) {
            $definition->addTag('serializer.attribute_metadata', ['for' => $attribute->class])->addTag('container.excluded', ['source' => 'because it\'s a serializer metadata extension']);
        });
    }
    private function registerJsonStreamerConfiguration(array $config, ContainerBuilder $container, PhpFileLoader $loader): void
    {
        ...
        $container->registerForAutoconfiguration(ValueTransformerInterface::class)->addTag('json_streamer.value_transformer');
    ...
    private function registerTypeInfoConfiguration(array $config, ContainerBuilder $container, PhpFileLoader $loader): void
    {
        ...
        if (ContainerBuilder::willBeAvailable('phpstan/phpdoc-parser', PhpDocParser::class, ['symfony/framework-bundle', 'symfony/type-info'])) {
            $container->register('type_info.resolver.string', StringTypeResolver::class)->setArguments([null, null, $config['aliases']]);
            $container->register('type_info.resolver.reflection_parameter.phpdoc_aware', PhpDocAwareReflectionTypeResolver::class)->setArguments([new Reference('type_info.resolver.reflection_parameter'), new Reference('type_info.resolver.string'), new Reference('type_info.type_context_factory')]);
            $container->register('type_info.resolver.reflection_property.phpdoc_aware', PhpDocAwareReflectionTypeResolver::class)->setArguments([new Reference('type_info.resolver.reflection_property'), new Reference('type_info.resolver.string'), new Reference('type_info.type_context_factory')]);
            $container->register('type_info.resolver.reflection_return.phpdoc_aware', PhpDocAwareReflectionTypeResolver::class)->setArguments([new Reference('type_info.resolver.reflection_return'), new Reference('type_info.resolver.string'), new Reference('type_info.type_context_factory')]);
            /** @var ServiceLocatorArgument $resolversLocator */
            $resolversLocator = $container->getDefinition('type_info.resolver')->getArgument(0);
            $resolversLocator->setValues(['string' => new Reference('type_info.resolver.string'), \ReflectionParameter::class => new Reference('type_info.resolver.reflection_parameter.phpdoc_aware'), \ReflectionProperty::class => new Reference('type_info.resolver.reflection_property.phpdoc_aware'), \ReflectionFunctionAbstract::class => new Reference('type_info.resolver.reflection_return.phpdoc_aware')] + $resolversLocator->getValues());
    ...
    private function registerLockConfiguration(array $config, ContainerBuilder $container, PhpFileLoader $loader): void
    {
        ...
        foreach ($config['resources'] as $resourceName => $resourceStores) {
            ...
            foreach ($resourceStores as $resourceStore) {
                ...
                if (!$usedEnvs && !str_contains($resourceStore, ':') && !\in_array($resourceStore, ['flock', 'semaphore', 'in-memory', 'null'], \true)) {
    ...
    private function registerMessengerConfiguration(array $config, ContainerBuilder $container, PhpFileLoader $loader, bool $validationEnabled, bool $lockEnabled): void
    {
        ...
        foreach ($config['transports'] as $name => $transport) {
            ...
            $tags = ['alias' => $name, 'is_failure_transport' => \in_array($name, $failureTransports, \true)];
            ...
            if (null !== $transport['retry_strategy']['service']) {
                ...
                $retryDefinition->replaceArgument(0, $transport['retry_strategy']['max_retries'])->replaceArgument(1, $transport['retry_strategy']['delay'])->replaceArgument(2, $transport['retry_strategy']['multiplier'])->replaceArgument(3, $transport['retry_strategy']['max_delay'])->replaceArgument(4, $transport['retry_strategy']['jitter']);
        ...
        $container->getDefinition('messenger.signing_serializer')->replaceArgument(2, $messageToSerializersMapping);
        ...
        if (\count($failureTransports) > 0) {
            ...
            $container->getDefinition('messenger.failure.send_failed_message_to_failure_transport_listener')->replaceArgument(0, $failureTransportsByTransportNameServiceLocator);
        } else {
    ...
    private function registerCacheConfiguration(array $config, ContainerBuilder $container): void
    {
        ...
        foreach ($config['pools'] as $name => $pool) {
            ...
            $isRedisTagAware = \in_array($pool['adapters'], $redisTagAwareAdapters, \true);
            foreach ($pool['adapters'] as $provider => $adapter) {
                if (\in_array($config['pools'][$adapter]['adapters'] ?? null, $redisTagAwareAdapters, \true)) {
                    $isRedisTagAware = \true;
    ...
    private function registerHttpClientConfiguration(array $config, ContainerBuilder $container, PhpFileLoader $loader): void
    {
        ...
        if (ContainerBuilder::willBeAvailable('guzzlehttp/uri-template', \OmniIconDeps\GuzzleHttp\UriTemplate\UriTemplate::class, [])) {
            $container->setAlias('http_client.uri_template_expander', 'http_client.uri_template_expander.guzzle');
        } elseif (ContainerBuilder::willBeAvailable('rize/uri-template', \OmniIconDeps\Rize\UriTemplate::class, [])) {
        ...
        foreach ($config['scoped_clients'] as $name => $scopeConfig) {
            ...
            $container->register($name, HttpClientInterface::class)->setFactory('current')->setArguments([[new Reference('http_client.transport')]])->addTag('http_client.client');
            $scopingDefinition = $container->register($name . '.scoping', ScopingHttpClient::class)->setDecoratedService($name, null, 15)->addTag('kernel.reset', ['method' => 'reset', 'on_invalid' => 'ignore']);
            if (null === $scope) {
                $baseUri = $scopeConfig['base_uri'];
                unset($scopeConfig['base_uri']);
                $scopingDefinition->setFactory([ScopingHttpClient::class, 'forBaseUri'])->setArguments([new Reference('.inner'), $baseUri, $scopeConfig]);
            } else {
                $scopingDefinition->setArguments([new Reference('.inner'), [$scope => $scopeConfig], $scope]);
            }
            ...
            $container->register($name . '.uri_template', UriTemplateHttpClient::class)->setDecoratedService($name, null, 10)->setArguments([new Reference('.inner'), new Reference('http_client.uri_template_expander', ContainerInterface::NULL_ON_INVALID_REFERENCE), $defaultUriTemplateVars]);
    ...
    private function registerCachingHttpClient(array $options, array $defaultOptions, string $name, ContainerBuilder $container): void
    {
        ...
        $container->register($name . '.caching', CachingHttpClient::class)->setDecoratedService($name, null, 20)->setArguments([new Reference('.inner'), new Reference($options['cache_pool']), $defaultOptions, $options['shared'], $options['max_ttl']]);
    }
    private function registerThrottlingHttpClient(string $rateLimiter, string $name, ContainerBuilder $container): void
    {
        ...
        $container->register($name . '.throttling.limiter', LimiterInterface::class)->setFactory([new Reference('limiter.' . $rateLimiter), 'create']);
        $container->register($name . '.throttling', ThrottlingHttpClient::class)->setDecoratedService($name, null, 5)->setArguments([new Reference('.inner'), new Reference($name . '.throttling.limiter')]);
    }
    private function registerRetryableHttpClient(array $options, string $name, ContainerBuilder $container): void
    {
        ...
        $container->register($name . '.retryable', RetryableHttpClient::class)->setDecoratedService($name, null, 25)->setArguments([new Reference('.inner'), $retryStrategy, $options['max_retries'], new Reference('logger')])->addTag('monolog.logger', ['channel' => 'http_client']);
    }
    private function registerMailerConfiguration(array $config, ContainerBuilder $container, PhpFileLoader $loader, bool $webhookEnabled): void
    {
        ...
        if ($config['headers']) {
            ...
            foreach ($config['headers'] as $name => $data) {
                $value = $data['value'];
                if (\in_array(strtolower($name), ['from', 'to', 'cc', 'bcc', 'reply-to'], \true)) {
                    $value = (array) $value;
                }
    ...
    private function registerNotifierConfiguration(array $config, ContainerBuilder $container, PhpFileLoader $loader, bool $webhookEnabled): void
    {
        ...
        if (ContainerBuilder::willBeAvailable('symfony/bluesky-notifier', NotifierBridge\Bluesky\BlueskyTransportFactory::class, ['symfony/framework-bundle', 'symfony/notifier'])) {
            $container->getDefinition($classToServices[NotifierBridge\Bluesky\BlueskyTransportFactory::class])->addArgument(new Reference('logger'))->addArgument(new Reference('clock', ContainerBuilder::NULL_ON_INVALID_REFERENCE));
        }
    ...
    private function registerRateLimiterConfiguration(array $config, ContainerBuilder $container, PhpFileLoader $loader): void
    {
        ...
        foreach ($config['limiters'] as $name => $limiterConfig) {
            ...
            $limiter = $container->setDefinition($limiterId = 'limiter.' . $name, new ChildDefinition('limiter'))->addTag('rate_limiter', ['name' => $name]);
            ...
            if (interface_exists(RateLimiterFactoryInterface::class)) {
                ...
                $container->getAlias(\sprintf('.%s $%s.limiter', RateLimiterFactory::class, $name))->setDeprecated('symfony/framework-bundle', '7.3', 'The "%alias_id%" autowiring alias is deprecated and will be removed in 8.0, use "RateLimiterFactoryInterface" instead.');
            }
        }
        ...
        foreach ($compoundLimiters as $name => $limiterConfig) {
            ...
            $container->register($limiterId = 'limiter.' . $name, CompoundRateLimiterFactory::class)->addTag('rate_limiter', ['name' => $name])->addArgument(new IteratorArgument(array_map(static fn(string $name) => new Reference('limiter.' . $name), $limiterConfig['limiters'])));
            $container->registerAliasForArgument($limiterId, RateLimiterFactoryInterface::class, $name . '.limiter', $name);
        }
    }
    ...
    private function getPublicDirectory(ContainerBuilder $container): string
    {
        ...
        $composerConfig = json_decode((new Filesystem())->readFile($composerFilePath), \true, flags: \JSON_THROW_ON_ERROR);
