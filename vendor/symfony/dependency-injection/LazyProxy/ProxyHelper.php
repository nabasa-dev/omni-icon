 ...
 */
namespace OmniIconDeps\Symfony\Component\DependencyInjection\LazyProxy;

trigger_deprecation('symfony/dependency-injection', '6.2', 'The "%s" class is deprecated, use "%s" instead.', ProxyHelper::class, \OmniIconDeps\Symfony\Component\VarExporter\ProxyHelper::class);
/**
