 ...
 */
namespace OmniIconDeps\Symfony\Component\HttpKernel;

use OmniIconDeps\Symfony\Component\Config\Builder\ConfigBuilderGenerator;
use OmniIconDeps\Symfony\Component\Config\ConfigCache;
...
use OmniIconDeps\Symfony\Component\DependencyInjection\Compiler\RemoveBuildParametersPass;
...
use OmniIconDeps\Symfony\Component\DependencyInjection\Dumper\PhpDumper;
...
use OmniIconDeps\Symfony\Component\HttpKernel\Bundle\BundleInterface;
...
use OmniIconDeps\Symfony\Component\HttpKernel\DependencyInjection\MergeExtensionConfigurationPass;
...
abstract class Kernel implements KernelInterface, RebootableInterface, TerminableInterface
{
    ...
    protected function initializeContainer(): void
    {
        ...
        if ($collectDeprecations = $this->debug && !\defined('OmniIconDeps\PHPUNIT_COMPOSER_INSTALL')) {
            $collectedLogs = [];
    ...
    public function __unserialize(array $data): void
    {
        ...
        if (\in_array(array_keys($data), [['environment', 'debug'], ["\x00*\x00environment", "\x00*\x00debug"]], \true)) {
