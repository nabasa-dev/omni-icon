 ...
 */
namespace OmniIconDeps\Symfony\Component\Routing\Generator;

use OmniIconDeps\Psr\Log\LoggerInterface;
use OmniIconDeps\Symfony\Component\Routing\Exception\InvalidParameterException;
use OmniIconDeps\Symfony\Component\Routing\Exception\MissingMandatoryParametersException;
use OmniIconDeps\Symfony\Component\Routing\Exception\RouteNotFoundException;
...
class UrlGenerator implements UrlGeneratorInterface, ConfigurableRequirementsInterface
{
    ...
    protected ?bool $strictRequirements = \true;
    /**
    ...
    public function __construct(protected RouteCollection $routes, protected RequestContext $context, protected ?LoggerInterface $logger = null, private ?string $defaultLocale = null)
    {
    }
