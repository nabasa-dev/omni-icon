...
class LiveCanvasService
{
    ...
    public function register_blocks(): void
    {
        ...
        $block = ['category' => 'Basic', 'block' => ['name' => 'Omni Icon', 'icon_html' => '<i class="fa fa-star" aria-hidden="true"></i>', 'template_html' => '<omni-icon name="omni:livecanvas" lc-helper="omni-icon" width="50"></omni-icon>'], 'options' => ['insertAt' => ['after' => 'Icon']]];
    ...
    public function editor_assets(): void
    {
        ...
        $this->viteService->enqueue_asset('resources/integration/livecanvas/editor.ts', ['handle' => OMNI_ICON::TEXT_DOMAIN . ':integration-livecanvas-editor', 'in_footer' => \true, 'dependencies' => ['wp-element', 'wp-components', 'wp-i18n', 'wp-data', 'react', 'react-dom']]);
    ...
    public function render_icon_panel(): void
    {
        ...
        <section item-type="omni-icon">
            <h1><?php 
        echo esc_html__('Omni Icon', 'omni-icon');
        ?></h1>
            ...
            <form class="add-common-form-elements">
                ...
                <div>
                    <label><?php 
        echo esc_html__('Icon Name', 'omni-icon');
        ?></label>
                    <input 
                        type="text" 
                        attribute-name="name" 
                    ...
                    >
                    <small><?php 
        echo esc_html__('Format: prefix:name (e.g., mdi:home, fa:github, lucide:star)', 'omni-icon');
        ?></small>
                </div>
                ...
                <div style="margin: 10px 0;">
                    ...
                    >
                        <?php 
        echo esc_html__('Browse Icons', 'omni-icon');
        ?>
                    </button>
                </div>
                ...
                <div style="position:relative">
                    <label><?php 
        echo esc_html__('Size', 'omni-icon');
        ?></label>
